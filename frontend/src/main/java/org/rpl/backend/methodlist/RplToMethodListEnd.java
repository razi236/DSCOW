...
public class RplToMethodListEnd extends Main {

    public static int doMain(RPLc args) {
        RplToMethodListEnd backend = new RplToMethodListEnd();
        //backend.importCSV();
    ...
    public int compile(RPLc args) throws Exception {
        ...
        */
        ...
        File file = new File("MethodList/methodList.txt");
        ...
        */
        ...
        try {
            ...
            System.setProperty("line.separator", System.lineSeparator());
            RplToMethodListFormatter formatter = new DefaultMethodListFormatter(writer);
            model.doABSTranslationStdLib = false;
            model.doABSTranslationResourceManager = false;
            model.doMethodListTranslation(writer, formatter);
